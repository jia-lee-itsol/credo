...
class _$CommentEntityImpl extends _CommentEntity {
  ...
  @override
  String toString() {
    return 'CommentEntity(commentId: $commentId, postId: $postId, userId: $userId, content: $content, authorNickname: $authorNickname, authorProfileImage: $authorProfileImage, isOfficial: $isOfficial, createdAt: $createdAt)';
  }
...
abstract class $LikeEntityCopyWith<$Res> {
  ...
  @useResult
  $Res call({String likeId, String postId, String userId, DateTime createdAt});
}
...
class _$LikeEntityImpl implements _LikeEntity {
  ...
  @override
  String toString() {
    return 'LikeEntity(likeId: $likeId, postId: $postId, userId: $userId, createdAt: $createdAt)';
  }
...
mixin _$ReportEntity {
  ...
  String get targetId =>
      throw _privateConstructorUsedError; // post_id 또는 comment_id
...
class _$ReportEntityImpl implements _ReportEntity {
  ...
  @override
  String toString() {
    return 'ReportEntity(reportId: $reportId, targetId: $targetId, targetType: $targetType, reporterId: $reporterId, reason: $reason, description: $description, status: $status, createdAt: $createdAt)';
  }
...
abstract class _ReportEntity implements ReportEntity {
  ...
  String get reportId;
  @override
  String get targetId; // post_id 또는 comment_id
  @override
