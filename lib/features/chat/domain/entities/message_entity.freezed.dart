...
class _$MessageEntityImpl extends _MessageEntity {
  ...
  @override
  String toString() {
    return 'MessageEntity(messageId: $messageId, conversationId: $conversationId, senderId: $senderId, content: $content, imageUrls: $imageUrls, readBy: $readBy, createdAt: $createdAt, updatedAt: $updatedAt, deletedAt: $deletedAt, deletedBy: $deletedBy, type: $type)';
  }
