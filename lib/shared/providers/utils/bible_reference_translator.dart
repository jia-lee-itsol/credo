/// 성경 참조 구절 변환 유틸리티
class BibleReferenceTranslator {
  /// 성경 참조 구절을 현재 언어로 변환
  /// 예: "マタイ 21:23-27" (일본어) -> "마태오 21:23-27" (한국어)
  static String translateBibleReference(String reference, String targetLanguage) {
    // 일본어 성경 책 이름 매핑
  ...
  static Map<String, Map<String, String>> _getBibleBookNameMap() {
    return {
      // 구약
      '創世記': {
        'ko': '창세기',
